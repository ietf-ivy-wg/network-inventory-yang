...
docname: draft-ietf-ccamp-network-inventory-yang-03
submissiontype: IETF
...
This document defines one YANG module "ietf-network-hardware-inventory" in {{ni-yang}}.
